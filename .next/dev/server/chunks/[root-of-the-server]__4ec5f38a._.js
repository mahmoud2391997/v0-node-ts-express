...
const AuditLogModel = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("AuditLog", auditLogSchema);
}),
...
async function GET(request) {
    try {
        ...
        const bookings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BookingModel"].find({}).populate("user").populate("room");
...
async function POST(request) {
    try {
        ...
        const existingBooking = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BookingModel"].findOne({
            user: userId,
            room: roomId,
        ...
        const booking = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BookingModel"]({
            ...rest,
            user: userId,
            room: roomId,
            startTime: new Date(startTime),
        ...
        await auditLog.save();
        const populatedBooking = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BookingModel"].findById(booking._id).populate("user").populate("room");
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(populatedBooking, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4ec5f38a._.js.map