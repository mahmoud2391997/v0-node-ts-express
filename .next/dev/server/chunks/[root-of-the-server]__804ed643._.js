...
const deviceSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"]({
    ...
    type: {
        type: String,
        enum: Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceType"]),
        required: true
    },
    status: {
        type: String,
        enum: Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceStatus"]),
        default: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceStatus"].OFF
    },
    lastUpdate: {
        type: String,
...
const DeviceModel = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("Device", deviceSchema);
}),
...
async function GET(request) {
    try {
        ...
        const devices = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Device$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceModel"].find({});
...
async function POST(request) {
    try {
        ...
        const device = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Device$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceModel"].create(body);
...
async function PUT(request) {
    try {
        ...
        const body = await request.json();
        const updatedDevice = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Device$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceModel"].findByIdAndUpdate(id, body, {
            new: true
        });
        if (!updatedDevice) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request) {
    try {
        ...
        const { searchParams } = new URL(request.url);
        const id = searchParams.get('id');
        const deletedDevice = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Device$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceModel"].findByIdAndDelete(id);
        if (!deletedDevice) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Device not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__804ed643._.js.map