...
"[project]/app/api/rooms/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params: paramsPromise }) {
    try {
        ...
        const room = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Room$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RoomModel"].findById(params.id);
        if (!room) {
...
async function PUT(request, { params: paramsPromise }) {
    try {
        ...
        const updatedRoom = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Room$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RoomModel"].findByIdAndUpdate(params.id, body, {
            new: true
        });
        if (!updatedRoom) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request, { params: paramsPromise }) {
    try {
        const params = await paramsPromise;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const deletedRoom = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Room$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RoomModel"].findByIdAndDelete(params.id);
        if (!deletedRoom) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Room not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e63752ee._.js.map